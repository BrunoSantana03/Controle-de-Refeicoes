...
Aplicativo React Native em JavaScript inspirado nas telas enviadas: listagem de refeicoes, cadastro, edicao, exclusao, resumo estatistico e telas de feedback.
